...
import com.java.wiki.pojo.Doc;
import com.java.wiki.pojo.DocExample;
...
//        for (Doc doc : docList) {
////            DocResp docNameResp = new DocResp();
////            BeanUtils.copyProperties(doc, docNameResp);
////          对象复制
//            DocResp docNameResp = CopyUtil.copy(doc, DocResp.class);
//            respList.add(docNameResp);
//        }
